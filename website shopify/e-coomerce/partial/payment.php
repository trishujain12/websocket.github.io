  ...
  ?>
    ...
    <form  method="post">
        <div class="container p-0" style="text-align:center;">
            <div class="card px-4">
                <p class="h8 py-3" style="color:white;text-align:center;font-size:30px;">Payment Details</p>
                <img src="img/qrcode.jfif" alt="" srcset="">
                <div class="row gx-3">
                    <div class="col-12">
                        <div class="d-flex flex-column">
                            <p class="text mb-1" style="color:white; font-size:20px;">Person Name</p>
                    ...
                    <div class="col-12">
                        <div class="d-flex flex-column">
                            <p class="text mb-1" style="color:white;font-size:20px;">Card Number</p>
                    ...
                    <div class="col-6">
                        <div class="d-flex flex-column">
                            <p class="text mb-1" style="color:white;font-size:20px;">Expiry</p>
                    ...
                    <div class="col-6">
                        <div class="d-flex flex-column">
                            <p class="text mb-1" style="color:white;font-size:20px;">CVV/CVC</p>
                            <input class="form-control mb-3 pt-2 " name="cvc" type="password" placeholder="***">
                            <span id="err"><?php echo $msg ; ?></span>
                        </div>
                    </div>
                    <div id="tp" class="col-12">
                        <button style=" padding:10px 12px;width:450px;background-color: pink;opacity: 0.6;" type="submit" name="submit">Pay </button>
