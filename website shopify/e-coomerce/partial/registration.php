...
$check_Email=mysqli_query($con,"SELECT * FROM `ecom` WHERE `email`='$email'");
$check_name=mysqli_query($con,"SELECT * FROM `ecom` WHERE `name`='$name'");
}
...
$sql="INSERT INTO `ecom`(`name`, `email`, `pswd`, `cpswd`) VALUES ('$name','$email','$pswd','$cpswd')";
