...
<nav class="navbar navbar-expand-lg bg-body-tertiary">
  <div class="container-fluid">
    ...
    <div class="collapse navbar-collapse" id="navbarSupportedContent">
      ...
      <form class="d-flex" role="search">
        ...
        <button id="td" class="btn btn-outline-success" type="submit" ><a href="partial/registration.php">SignUp </a> </button>
        <button id="td" class="btn btn-outline-success" type="submit"><a href="partial/login.php"> SingIn </a></button>
      </form>
    </div>
  </div>
</nav>
  ...
  <div class="carousel-inner">
    <div class="carousel-item active">
      <img src="img/alp2.png" class="d-block w-100" alt="...">
    </div>
    ...
    <!-- course video -->
   <?php include "partial/tutBody.php";?>
